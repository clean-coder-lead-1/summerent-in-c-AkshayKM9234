...
**Plan to make the code easily understandable and readable by reducing the complexity, adding more comments, following a meaningful naming convention practice and following code formatting**
